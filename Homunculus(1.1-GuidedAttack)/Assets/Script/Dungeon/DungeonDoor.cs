...
public class DungeonDoor : MonoBehaviour
{
    ...
    Vector2 getNextRoomPos()
    {
        ...
        {
            hitData = Physics2D.Raycast(new Vector2(transform.position.x + 2f, transform.position.y), transform.right, maxRayDistance, LayerMask.GetMask("RoomScanner"));
        ...
        {
            hitData = Physics2D.Raycast(new Vector2(transform.position.x - 1f, transform.position.y), -1*transform.right, maxRayDistance, LayerMask.GetMask("RoomScanner"));
        ...
        {
            hitData = Physics2D.Raycast(new Vector2(transform.position.x, transform.position.y - 1f), -1*transform.up, maxRayDistance, LayerMask.GetMask("RoomScanner"));
        ...
        {
            hitData =  Physics2D.Raycast(new Vector2(transform.position.x, transform.position.y + 1f), transform.up, maxRayDistance, LayerMask.GetMask("RoomScanner"));
